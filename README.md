...
Note: readme for each prototypes can be found inside the directory of each task and also the final-project

## 📦 Prototypes

1. tasks1: a simple task-manager 
2. tasks2: added linking and editing to tasks1
3. tasks3: addition of pytest
4. tasks4: uses OpenAI's chat API to generate short, predictable summaries.
5. task5: use spec-kit to build and plan a task-manager
