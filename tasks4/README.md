...
- Sends each description to the OpenAI API with a system prompt that instructs the model to return a terse phrase (5 words or fewer).- Sends each description to the OpenAI API with a system prompt that instructs the model to return a terse phrase (5 words or fewer).

- Prints the original description and the generated short summary.- Prints the original description and the generated short summary.
